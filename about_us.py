...
def draw_about_us(window, scroll_y):
    if scroll_y > 0:
        scroll_y = 0
    elif scroll_y < -100:
        scroll_y = -100
    ...
    # Header image
    pg.draw.rect(window,PURPLE, (0, 100+scroll_y, 432, 256))
    window.blit(bakery_img, (50, 100+scroll_y))
    window.blit(about_us, (0, 130+scroll_y))
    ...
    for i in range(len(detail)):
        ...
        if i == 0 or i == 6:
            ...
            x = 100
        window.blit(paragraph.render(detail[i], True, BLACK), (x, 356+i*24+scroll_y))

    # Footer image
    pg.draw.rect(window, BLUE, (0, 612+scroll_y, 432, 256))
    window.blit(bakery_img2, (0, 612+scroll_y))
    window.blit(about_us2, (390, 640+scroll_y))
